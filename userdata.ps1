<powershell>
 ...
 $env:CHEF_SERVER_NAME = "chef-automation-svr" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "chef-automation-svr-cif47tsw4ejresn3.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
