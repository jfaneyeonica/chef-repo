...
CHEF_SERVER_NAME="chef-automation-svr" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="chef-automation-svr-cif47tsw4ejresn3.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
